...
//     * the notifier
//     */
//    private EaseNotificationManager notifier = null;
//
//
//
//    private EaseUI(){}
...
//    }
//
//    protected EaseNotificationManager createNotifier(){
//        return EaseNotificationManager .getInstance();
//    }
//
//    public EaseNotificationManager getNotifier(){
//        return notifier;
//    }
//
//
...
//                    // EMLog.d("Process", "Id: "+ info.pid +" ProcessName: "+
...
//                }
//            } catch (Exception e) {
//                // EMLog.d("Process", "Error>> :"+ e.toString());
//            }
//        }
//        return processName;
//    }
...
//    }
//
//    public interface EaseUserInfoProvider<T>{
//        public Observable<EaseUser<T>> getEaseUser(String userName);
//    }
//
//
//}
