...
public class SPUtils {
    ...
    /**
     * get Set<String> preferences, default is null
     *
     * @param context
     * @param key     The name of the preference to retrieve
     * @return The preference value if it exists, or false. Throws ClassCastException if there is a preference with this
     ...
     * @return True if the new values were successfully written to persistent storage.
     */
    public static Set<String> getSetString(Context context, String key, Set<String> value) {
        SharedPreferences settings = context.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
        return settings.getStringSet(key, value);
    }
    ...
    public static Set<String> getSetString(Context context, String key) {
        return getSetString(context, key, null);
    }
