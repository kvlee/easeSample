...
import com.hyphenate.easeui.model.manager.EaseVoiceRecorder;
import com.hyphenate.easeui.ui.impl.EaseChatRowVoicePlayClickListener;
...
public class EaseVoiceRecorderView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        wakeLock = ((PowerManager) context.getSystemService(Context.POWER_SERVICE)).newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK, "easeUi");
    }
