package com.hyphenate.easeui.ui.widget.emojicon;
...
import com.hyphenate.easeui.model.domain.EaseEmojiconGroupEntity;
import com.hyphenate.easeui.ui.adapter.EmojiGridAdapter;
import com.hyphenate.easeui.ui.adapter.EmojiPagerAdapter;
...
public class EaseEmojiconPagerView extends ViewPager {
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList, int emijiconColumns, int bigEmojiconColumns){
        ...
        pagerAdapter = new EmojiPagerAdapter(viewpages);
    ...
    public List<View> getGroupGridViews(EaseEmojiconGroupEntity groupEntity){
        ...
        for(int i = 0; i < pageSize; i++){
            ...
            final EmojiGridAdapter gridAdapter = new EmojiGridAdapter(context, 1, list, emojiType);
