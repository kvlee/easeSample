...
public class EaseNotificationManager {
    ...
    private EaseNotificationManager() {
    }

    private static EaseNotificationManager instance;

    public synchronized static EaseNotificationManager getInstance(){
        if(instance == null){
            instance = new EaseNotificationManager();
        }
        return instance;
    }
    /**
     ...
     * @return
     */
    public EaseNotificationManager init(Context context){
        appContext = context;
    ...
    public synchronized void onNewMsg(EMMessage message) {
        ...
        EaseUIHelper.EaseSettingsProvider settingsProvider = EaseUIHelper.getInstance().getEaseSettingsProvider();
